  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <Text style={styles.description}>
        This web app provides a centralized space for Kusile Group operations — allowing staff to manage financial
        requisitions, leases, HR processes, and company vehicles efficiently.{"\n\n"}
        Department heads can upload important documents, track requests, and approve submissions in real time.
      </Text>
