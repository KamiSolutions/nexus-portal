...
export default function ApprovedFinancialsScreen() {
  const [approvedList, setApprovedList] = useState<ApprovedFinancial[]>([
    { id: 1, description: 'Stationery Requisition', amount: 1200, date: '2025-10-01' },
    { id: 2, description: 'Office Chairs Requisition', amount: 4500, date: '2025-10-05' },
  ]);
      ...
      <View style={styles.listContainer}>
        {approvedList.map((item) => (
          <View key={item.id} style={styles.card}>
            ...
            <Text style={styles.cardText}>Amount: ZAR {item.amount.toLocaleString()}</Text>
