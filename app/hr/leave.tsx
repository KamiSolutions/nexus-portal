...
export default function LeaveScreen() {
  ...
  const handleAddLeave = () => {
    if (!newLeave.employee || !newLeave.line_manager || !newLeave.leave_type || !newLeave.period_from || !newLeave.period_to) {
    ...
    setNewLeave({ employee: '', line_manager: '', leave_type: '', period_from: '', period_to: '' });
  };
    ...
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <View style={styles.formContainer}>
        ...
        <TextInput
          ...
          onChangeText={(text) => setNewLeave({ ...newLeave, line_manager: text })}
        />
        <TextInput
          style={styles.input}
          placeholder="Leave Type (e.g., Sick, Annual, Family Responsibility)"
          value={newLeave.leave_type}
          onChangeText={(text) => setNewLeave({ ...newLeave, leave_type: text })}
        />
        <TextInput
          style={styles.input}
          placeholder="Start Date (YYYY-MM-DD)"
          value={newLeave.period_from}
          onChangeText={(text) => setNewLeave({ ...newLeave, period_from: text })}
        />
        <TextInput
          style={styles.input}
      ...
      <View style={styles.listContainer}>
        {leaves.map((l) => (
          <View key={l.id} style={styles.card}>
            ...
            <Text style={styles.cardText}>Period: {l.period_from} → {l.period_to}</Text>
